    ...
    <div className={styles.container}>
      ...
      <main style={{padding:"25px"}}>
        <Heading>NFT Metadata</Heading>
          <Input variant='flushed' value={contractAddr} style={{marginBottom:"15px"}} placeholder='Basic usage' onChange={(e) => setContractAddr(e.target.value)} />
          <SimpleGrid columns={{sm: 1, md: 3, lg: 5}} gap={6}>
            <Input variant='flushed' value={tokenID} placeholder='Basic usage' onChange={(e) => setTokenID(e.target.value)} />
